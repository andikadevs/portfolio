    ...
    <AnimateOnView direction="left">
      <div>
        ...
        <p className="text-text mb-6">
          ...
          on July 9th, 2005, and I have lived there ever since. Computers were
          not really my thing, I have no access to `computer` back then. My
          first time handling a computer was when I was in Senior High School. I
          couldn`t even switch on a computer back then. However, I found my
          passion there. I have always studied hard ever since, working on
        ...
        <p className="text-text mb-2">
          <span className="text-accent">Nationality :&nbsp;</span>
          Indonesia
        </p>
        <p className="text-text mb-2">
